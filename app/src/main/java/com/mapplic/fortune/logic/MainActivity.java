...
public class MainActivity extends AppCompatActivity {
    ...
    Button mPlusButton;
    @BindView(R.id.spinButton)
    Button mSpinButton;

    @BindView(R.id.jackpotTextView)
    TextView mJackpotTextView;
    @BindView(R.id.myCoinsTextView)
    TextView mMyCoinsTextView;
    @BindView(R.id.betTextView)
    TextView mBetTextView;
